...
namespace QRBankPay
{
    public static class Startup
    {
        ...
        //private const string SINGLE_INSTANCE_SERVICES_NAMESPACE = "QRBankPay.Services.SingleInstance";
        private const string VIEW_MODELS_NAMESPACE = "QRBankPay.ViewModels";
